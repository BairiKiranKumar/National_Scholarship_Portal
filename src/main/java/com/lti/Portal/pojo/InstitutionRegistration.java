...
@Entity
@Table(name="institutioregistration")
public class InstitutionRegistration {
	...
	public String toString() {
		return "InstitutionRegistration [institutionCategory=" + institutionCategory + ", name=" + name + ", inststate="
				+ inststate + ", instdistrict=" + instdistrict + ", InstitutionCode=" + InstitutionCode + ", email="
				+ email + ", DISEcode=" + DISEcode + ", Location=" + Location + ", InstitutionType=" + InstitutionType
	...
	public InstitutionRegistration(String institutionCategory, String name, String inststate, String instdistrict,
	...
	public String getAffilatedUniversityStateBoardName() {
		return AffilatedUniversityBoardName;
	}
	public void setAffilatedUniversityStateBoardName(String affilatedUniversityStateBoardName) {
		AffilatedUniversityBoardName = affilatedUniversityStateBoardName;
	}
	public String getYearFromAdmissionStarted() {
		return YearFromWhichAdmissionStarted;
	}
	public void setYearFromAdmissionStarted(String yearFromAdmissionStarted) {
		YearFromWhichAdmissionStarted = yearFromAdmissionStarted;
	}
